        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><small>E-Cash</small></a>
                </div>
                <div style="color: white;
                            padding: 15px 50px 5px 50px;
                            float: right;
                            font-size: 16px;">
                &nbsp; &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust" title="Logout">Log Out</a> </div>
            </nav>
            <!-- /. NAV TOP  -->
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li class="text-center">
                            <img src="assets/img/user1.png" class="user-image img-responsive" />
                        </li>
